          ...
          <FiltersWrapper>
            ...
            <Filter>
              ...
              <select
                ...
                <option value="price-asc">precio, barato primero</option>
                <option value="price-desc">precio, caro primero</option>
                <option value="_id-desc">Nuevo primero</option>
                <option value="_id-asc">Mas antiguo primero</option>
              </select>
            </Filter>
          </FiltersWrapper>
        </CategoryHeader>
